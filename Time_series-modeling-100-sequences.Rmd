...
VPM_awake_15=window(firing_param15_Awake$VPM,start = 1,end=1000)
LD_awake_15=window(firing_param15_Awake$LD,start = 1,end=1000)
PO_awake_15=window(firing_param15_Awake$PO,start = 1,end=1000)
...
-   **Impulse Response Functions (IRFs):** You can safely compute IRFs since the system is stable.
...
Overall, your model is well-specified and meets the necessary stability criteria.
...
VPM_ISO_15=window(firing_param15_ISO$VPM,start = 1,end=8000)
LD_ISO_15=window(firing_param15_ISO$LD,start = 1,end=8000)
PO_ISO_15=window(firing_param15_ISO$PO,start = 1,end=8000)

df_ISO_15=data.frame(VPM_ISO_15,LD_ISO_15,PO_ISO_15)
...
adf.test(df_ISO_15$VPM_ISO_15) # to check stationarity 
adf.test(df_ISO_15$LD_ISO_15)
adf.test(df_ISO_15$PO_ISO_15)
#var()
...
```{r}
model_ISO_15=VAR(df_ISO_15,p=13)
...
```{r}
causality(model_ISO_15,"VPM_ISO_15")
causality(model_ISO_15,"LD_ISO_15")
causality(model_ISO_15,"PO_ISO_15")
